...
namespace CalendarCodeTests
{
    public class TestConstants
    {
        ...
        static public List<Category> getDefaultCategories()
        {
            ...
            new Category(4,"Medical", Category.CategoryType.Event),
            new Category(5,"Sleep", Category.CategoryType.Event),
            new Category(6,"Working", Category.CategoryType.AllDayEvent),
            new Category(7,"On Call", Category.CategoryType.AllDayEvent),
            new Category(8,"Canadian Holidays", Category.CategoryType.Availability),
            new Category(9,"Vacation", Category.CategoryType.Holiday),
            new Category(10,"Wellness days", Category.CategoryType.Holiday),
            new Category(11,"Birthdays", Category.CategoryType.Holiday),
            new Category(12,"Non Standard", Category.CategoryType.Event),
            };
        }
